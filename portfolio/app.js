...
function initProjects() {
  const projectData = [
    { name: 'Evalify', desc: 'My top edtech project: a multi-tenant AICTE platform for evidence uploads, mentor verification, activity points, and institutional reporting.', tags: ['React', 'Node.js', 'MongoDB'], type: 'TOP PROJECT', status: 'TOP PROJECT', github: 'https://github.com/Majenayu/Evalify', live: 'https://symboit-60sd.onrender.com', demo: '' },
    { name: 'Anveshan / SUNDAY', desc: 'My top research build: an AI yoga coach with voice guidance, real-time pose detection, posture correction, scoring, and progress tracking.', tags: ['Python', 'TensorFlow.js', 'Computer Vision'], type: 'TOP PROJECT', status: 'TOP PROJECT', github: 'https://github.com/Majenayu/Anveshan', live: 'https://asanaminds.onrender.com', demo: '' },
    ...
    { name: 'Job Application Automation', desc: 'Local job-search assistant that discovers roles, scores them against your profile, drafts cover letters, tracks applications, and sends daily updates.', tags: ['Python', 'Automation', 'AI'], type: 'PRODUCTIVITY', status: 'WORKING', github: 'https://github.com/Majenayu/Jobs', live: '', demo: '' },
    { name: 'Navigation Project', desc: 'Bus-tracking prototype with route and movement information designed to make local transport easier to follow.', tags: ['JavaScript', 'Maps', 'PWA'], type: 'SMART MOBILITY', status: 'LIVE', github: 'https://github.com/Majenayu/Navigation-Project', live: 'https://navigation-project-7z0i.onrender.com', demo: '' },
    { name: 'MessMate', desc: 'Smart mess-management system with time-based food ordering, daily tokens, and live order-status updates.', tags: ['JavaScript', 'Node.js', 'Web App'], type: 'CAMPUS TECH', status: 'WORKING', github: 'https://github.com/Majenayu/SLR1.0', live: '', demo: '' },
    ...
    { name: 'Fare Price Calculator', desc: 'Small focused utility for calculating travel fares from user inputs, published as a lightweight static web tool.', tags: ['JavaScript', 'HTML', 'Utility'], type: 'WEB TOOL', status: 'IDEA', github: 'https://github.com/Majenayu/Fare_price', live: 'https://majenayu.github.io/Fare_price/', demo: '' },
    { name: 'WALLMART Suite', desc: 'A set of e-commerce prototypes exploring a storefront, shopping cart, and security layer as separate product surfaces.', tags: ['HTML', 'JavaScript', 'E-Commerce'], type: 'PRODUCT CONCEPT', status: 'PROTOTYPE', github: 'https://github.com/Majenayu/WALLMART', live: 'https://wallmart-2ra6.onrender.com', demo: '' },
  ];
