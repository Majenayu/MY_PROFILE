const fallback = {
  ...
  awards: [
    { title: 'Best Behaviour Award · Year 1', rating: 'SPECIAL PRIZE', description: 'Recognized as the sole recipient among 120 students in the first year of B.E. CSE (AI & ML) for exemplary conduct, discipline, and positive contribution to the college community.', date: 'DATE UNVERIFIED', image: '' },
    { title: 'Best Extra-Curricular Award · Year 2', rating: 'ONE OF 120', description: 'Received the department-level Best Extra-Curricular award as the only selected student among 120 classmates for sustained performance beyond the classroom.', date: 'DATE UNVERIFIED', image: '' },
    { title: 'Best Co-Curricular Award · Year 3', rating: 'ONE OF 120', description: 'Selected as the only student among 120 in the batch for outstanding co-curricular performance, initiative, and contribution during the third year of B.E. CSE (AI & ML).', date: 'DATE UNVERIFIED', image: '' },
    { title: 'Code Hunt 2025', rating: 'THIRD PLACE', description: 'Led the We Code Debuggers team to third place in Code Hunt 2025, coordinating the team’s problem-solving approach and technical execution.', date: '2025', image: '' },
    { title: 'NCC ATC Camp', rating: 'COLLEGE RUNNER-UP', description: 'Attended the NCC ATC Camp in 2024. Led and controlled a complete school of 75 cadets as a leading cadet while the college team achieved runner-up position among participating colleges.', date: '2024', image: '' },
    { title: 'NCC B Certificate', rating: 'A GRADE', description: 'Successfully completed the NCC B Certificate examination with an A grade, demonstrating strong performance in training, discipline, and cadet responsibilities.', date: 'DATE UNVERIFIED', image: '' },
    { title: 'EBSB National Camp · Ballari', rating: '25-DAY CAMP', description: 'Represented the NCC in the Ek Bharat Shreshtha Bharat national camp at Ballari, completing 25 days of training, cultural exchange, and national integration activities.', date: 'DATE UNVERIFIED', image: '' },
    { title: 'Infosys Global Hackathon', rating: 'REGIONAL FINALIST', description: 'Participated in the Infosys Global Hackathon and advanced to the regional finals through collaborative problem-solving and prototype development.', date: 'DATE UNVERIFIED', image: '' },
    { title: 'NCC CATC Camp', rating: 'PO CADET LEADER', description: 'Attended the 2025 CATC Camp and led the entire college contingent as a PO Cadet for 12 days, coordinating cadet participation and camp responsibilities.', date: '2025', image: '' },
    { title: 'NCC Open Day 2025', rating: 'SECOND RUNNER-UP', description: 'Represented the VVCE NCC unit at Open Day 2025, where the club secured second runner-up position in the competition.', date: '2025', image: '' },
    { title: 'VVCE Idea Generation Competition', rating: 'FIRST PLACE', description: 'Won first place in the VVCE Idea Generation competition by presenting and defending an original solution with the team.', date: '2025', image: '' },
    { title: 'VVCE Mini Project Competition', rating: 'FIRST PLACE', description: 'Won first place in the VVCE Mini Project Competition for a practical student project presented to the college evaluation panel.', date: '2025', image: '' },
    { title: 'Code of Duty', rating: 'EVENT ORGANIZER', description: 'Helped conduct the Code of Duty event as a member of the VectorFlow Club, contributing to planning, coordination, and participant experience.', date: 'DATE UNVERIFIED', image: '' },
    { title: 'Tech Spark', rating: 'WINNER', description: 'Won Tech Spark with teammate Aashish, finishing first among 50 teams through a strong idea, prototype, and final presentation.', date: 'DATE UNVERIFIED', image: '' },
    { title: 'IEEE Anveshan 2025 · AsanMinds', rating: 'NATIONAL WINNER', description: 'Won first place in the Education domain at IEEE Anveshan 2025 with AsanMinds. The team cleared regional selection from more than 300 applicants, placed first among 25 regional teams, and won the final among 50 teams.', date: '2025', image: '' },
    { title: 'VVCE Idea Generation · Phase 2', rating: 'FIRST PLACE', description: 'Secured first place again in Phase 2 of the VVCE Idea Generation competition, extending the team’s record of innovation recognition.', date: 'DATE UNVERIFIED', image: '' },
    { title: 'IEEE Bar Camp', rating: 'FIRST PLACE', description: 'Won first place at the IEEE Bar Camp among 40 participating teams through collaborative technical problem-solving and presentation.', date: 'DATE UNVERIFIED', image: '' },
    { title: 'VVCE NCC Cadet Captain', rating: '100 CADETS', description: 'Appointed Cadet Captain of VVCE NCC and officially entrusted with leadership of approximately 100 cadets.', date: 'DATE UNVERIFIED', image: '' },
    { title: 'Sea Training Camp · Mumbai', rating: 'KARNATAKA REPRESENTATIVE', description: 'Attended a 25-day Sea Training Camp in Mumbai as Cadet Captain, representing Karnataka alongside seven other selected cadets.', date: 'DATE UNVERIFIED', image: '' },
    { title: 'Super 60 Project Building', rating: 'THIRD PLACE', description: 'Won third place in a project-building competition among the Super 60 students with the team.', date: 'DATE UNVERIFIED', image: '' },
    { title: 'Prayog 24-Hour Hackathon', rating: 'RUNNER-UP', description: 'Finished runner-up at the Prayog 24-hour hackathon with a cross-disciplinary mechanical team, contributing under a time-limited build challenge.', date: '2025', image: '' },
    { title: 'VVCE Mini Project · Phase 2', rating: 'FIRST PLACE', description: 'Won first place in the second phase of the VVCE Mini Project competition for the team’s continued project development and presentation.', date: 'DATE UNVERIFIED', image: '' },
    { title: 'Ergonomic Model Industry Study', rating: 'FIELD STUDY', description: 'Conducted an ergonomic model study and gathered industry information to understand practical workplace needs and apply them to the model.', date: 'DATE UNVERIFIED', image: '' },
...
function initProjects() {
  const projectData = [
    ...
    { name: 'Quiz Learning Platform', desc: 'Multilingual quiz system for government-school students with live rooms, teacher controls, analytics, and leaderboards.', tags: ['Python', 'Flask', 'MongoDB'], type: 'EDTECH', status: 'LIVE', github: 'https://github.com/Majenayu/Python_Boot_Camp', live: 'https://python-boot-camp.onrender.com', demo: '' },
    { name: 'Plastic AI', desc: 'Waste-classification platform with image prediction, eco scores, disposal tips, JWT authentication, and a sustainability dashboard.', tags: ['TensorFlow', 'FastAPI', 'Node.js'], type: 'AI / CLIMATE', status: 'LIVE', github: 'https://github.com/Majenayu/NITK2025', live: 'https://nitk2025-node.onrender.com', demo: '' },
    { name: 'Virtual Try-On', desc: 'Browser-based virtual clothing try-on using webcam pose detection and real-time Canvas overlays.', tags: ['JavaScript', 'MediaPipe', 'WebRTC'], type: 'AI / AR', status: 'LIVE', github: 'https://github.com/Majenayu/CodeBreakers-vvce', live: 'https://codebreakers-vvce.onrender.com', demo: '' },
    { name: 'Job Application Automation', desc: 'Local job-search assistant that discovers roles, scores them against your profile, drafts cover letters, tracks applications, and sends daily updates.', tags: ['Python', 'Automation', 'AI'], type: 'PRODUCTIVITY', status: 'WORKING', github: '', archive: 'https://github.com/Majenayu', live: '', demo: '' },
    { name: 'Navigation Project', desc: 'Bus-tracking prototype with route and movement information designed to make local transport easier to follow.', tags: ['JavaScript', 'Maps', 'PWA'], type: 'SMART MOBILITY', status: 'LIVE', github: '', archive: 'https://github.com/Majenayu', live: 'https://navigation-project-7z0i.onrender.com', demo: '' },
    { name: 'MessMate', desc: 'Smart mess-management system with time-based food ordering, daily tokens, and live order-status updates.', tags: ['JavaScript', 'Node.js', 'Web App'], type: 'CAMPUS TECH', status: 'WORKING', github: '', archive: 'https://github.com/Majenayu', live: '', demo: '' },
    { name: 'Mysore Chartbot', desc: 'A local information chatbot that answers questions about Mysuru using a curated places dataset and a simple JavaScript backend.', tags: ['JavaScript', 'Node.js', 'Chatbot'], type: 'AI / LOCAL', status: 'LIVE', github: 'https://github.com/Majenayu/AI_Chatbot', live: 'https://ai-chatbot-ok64.onrender.com', demo: '' },
    { name: 'EcoTrack', desc: 'Carbon-footprint calculator for transport, home energy, and diet with personalized reduction suggestions and saved progress.', tags: ['JavaScript', 'Maps', 'LocalStorage'], type: 'CLIMATE TECH', status: 'WORKING', github: 'https://github.com/Majenayu/CARBON-FOOT-PRINT', live: '', demo: '' },
    { name: 'Election Assistant', desc: 'Civic information platform with an AI chatbot, election sentiment analysis, issue tracking, quizzes, timelines, and simulations.', tags: ['Next.js', 'TypeScript', 'AI'], type: 'CIVIC TECH', status: 'LIVE', github: 'https://github.com/Majenayu/election-assistant', live: 'https://election-assistant-xi.vercel.app', demo: '' },
    { name: 'Face Recognition System', desc: 'Computer-vision system that trains on face images and recognizes people from images or video using OpenCV and LBPH.', tags: ['Python', 'OpenCV', 'Machine Learning'], type: 'COMPUTER VISION', status: 'WORKING', github: 'https://github.com/Majenayu/Face-recognization', live: '', demo: '' },
    { name: 'Gram-Verify', desc: 'Rural banking concept for document authentication, land verification, loan eligibility scoring, and transparent nominee notifications.', tags: ['Node.js', 'MongoDB', 'Cloudinary'], type: 'CIVIC / FINTECH', status: 'LIVE', github: 'https://github.com/Majenayu/Gram-Verify', live: 'https://gram-verify.onrender.com', demo: '' },
    { name: 'Patient Records', desc: 'Healthcare record-management application with patient registration, prescriptions, emergency details, history, and admin dashboards.', tags: ['JavaScript', 'Node.js', 'Web App'], type: 'HEALTH TECH', status: 'LIVE', github: 'https://github.com/Majenayu/Hack_titans', live: 'https://hack-titans.onrender.com', demo: '' },
    { name: 'EcoRoute', desc: 'Smart waste-collection PWA concept for planning pickups and making city waste operations easier to coordinate.', tags: ['JavaScript', 'PWA', 'Maps'], type: 'SMART CITY', status: 'CONCEPT', github: 'https://github.com/Majenayu/infothon2.0', live: '', demo: '' },
    { name: 'ASL Gesture Recognition', desc: 'Webcam-based computer-vision tool that recognizes American Sign Language letters A-Z, spaces, confirmations, and corrections.', tags: ['Python', 'MediaPipe', 'Computer Vision'], type: 'ACCESSIBILITY', status: 'WORKING', github: 'https://github.com/Majenayu/Python_Botcamp', live: '', demo: '' },
    { name: 'Vidyuth Verse', desc: 'Renewable-energy dashboard concept for India, focused on regional deployment data, energy insights, and carbon calculations.', tags: ['React', 'TypeScript', 'PostgreSQL'], type: 'CLIMATE DATA', status: 'LIVE', github: 'https://github.com/Majenayu/Prompt_to_Product', live: 'https://prompt-to-product-at40.onrender.com', demo: '' },
    { name: 'S3 Image Vault', desc: 'Full-stack image gallery with authentication, owner-only deletion, AWS S3 storage, and optional CloudFront delivery.', tags: ['React', 'AWS S3', 'MongoDB'], type: 'CLOUD', status: 'LIVE', github: 'https://github.com/Majenayu/s3_cloudfront_simple_integration', live: 'https://s3-cloudfront-simple-integration.vercel.app', demo: '' },
    { name: 'ScamShield', desc: 'Voice-phishing detection concept that uses Twilio calls, security questions, speech analysis, AI threat scoring, and alerts.', tags: ['Python', 'Twilio', 'Groq AI'], type: 'SECURITY / AI', status: 'CONCEPT', github: 'https://github.com/Majenayu/Tecknotsava', live: '', demo: '' },
    { name: 'Treasure Hunt 2K26', desc: 'Interactive event platform with team management, screenshots, push notifications, and a service-worker-powered web experience.', tags: ['JavaScript', 'PWA', 'Node.js'], type: 'EVENT TECH', status: 'WORKING', github: 'https://github.com/Majenayu/Treasure-Hunt-2K26', live: '', demo: '' },
    { name: 'MajenEye', desc: 'Interactive eye and mouse tracker with animated eyes following cursor movement across a responsive React interface.', tags: ['React', 'JavaScript', 'UI'], type: 'INTERACTION', status: 'LIVE', github: 'https://github.com/Majenayu/Majen_Eye', live: 'https://majen-eye-1.onrender.com', demo: '' },
    { name: 'Tadasana AI Trainer', desc: 'Focused pose-training experience using MoveNet to analyze Mountain Pose alignment and give real-time biomechanical feedback.', tags: ['Python', 'MoveNet', 'AI'], type: 'HEALTH AI', status: 'PROTOTYPE', github: 'https://github.com/Majenayu/model', live: '', demo: '' },
    { name: 'Campus Face Recognition', desc: 'Campus identity system combining a face-recognition service, dashboards, student models, and a Node.js web layer.', tags: ['Python', 'OpenCV', 'Node.js'], type: 'CAMPUS AI', status: 'PROTOTYPE', github: 'https://github.com/Majenayu/Campus_Face_Recognization', live: '', demo: '' },
    { name: 'Security Protocols', desc: 'Security-themed installable web experience with a PWA shell, service worker, manifest, and interactive frontend.', tags: ['JavaScript', 'PWA', 'Node.js'], type: 'SECURITY', status: 'LIVE', github: 'https://github.com/Majenayu/JNNCE-', live: 'https://jnnce.onrender.com', demo: '' },
    { name: 'Fare Price Calculator', desc: 'Small focused utility for calculating travel fares from user inputs, published as a lightweight static web tool.', tags: ['JavaScript', 'HTML', 'Utility'], type: 'WEB TOOL', status: 'IDEA', github: '', archive: 'https://github.com/Majenayu', live: '', demo: '' },
    { name: 'WALLMART Suite', desc: 'A set of e-commerce prototypes exploring a storefront, shopping cart, and security layer as separate product surfaces.', tags: ['HTML', 'JavaScript', 'E-Commerce'], type: 'PRODUCT CONCEPT', status: 'PROTOTYPE', github: '', archive: 'https://github.com/Majenayu', live: 'https://wallmart-2ra6.onrender.com', demo: '' },
  ];
  ...
  function expandProject(idx) {
    ...
    const proofLinks = [
      ['SOURCE REPOSITORY', p.github],
      ['LIVE PREVIEW', p.live],
      ['VIDEO DEMO', p.demo],
      ['PROFILE ARCHIVE', p.archive]
    ].filter(([, url]) => url);
    $('#pj-detail-proof').innerHTML = `<span class="pj-proof-label">AVAILABLE PROOF</span><div>${proofLinks.map(([label, url]) => `<a href="${escapeHtml(url)}" target="_blank" rel="noreferrer"><strong>${label}</strong><small>${escapeHtml(url.replace(/https?:\/\//, '').replace(/\/$/, ''))}</small><b>↗</b></a>`).join('')}</div>`;
    ...
    if (p.github) actions += `<a class="pj-detail-act-secondary" href="${escapeHtml(p.github)}" target="_blank" rel="noreferrer">SOURCE ↗</a>`;
    if (!p.github && p.archive) actions += `<a class="pj-detail-act-secondary" href="${escapeHtml(p.archive)}" target="_blank" rel="noreferrer">PROFILE ARCHIVE ↗</a>`;
