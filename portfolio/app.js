...
function initProjects() {
  const projectData = [
    { name: 'Evalify', desc: 'My top edtech project: an AICTE activity-points platform for evidence uploads, mentor verification, approvals, and student support workflows.', tags: ['Node.js', 'MongoDB', 'Express'], type: 'EDTECH', status: 'TOP PROJECT', github: '', live: '', demo: '' },
    { name: 'Anveshan', desc: 'My top research project, built around intelligent systems, experimental problem-solving, and research-led innovation.', tags: ['Python', 'Machine Learning', 'Research'], type: 'RESEARCH', status: 'TOP PROJECT', github: 'https://github.com/Majenayu/Anveshan', live: '', demo: '' },
